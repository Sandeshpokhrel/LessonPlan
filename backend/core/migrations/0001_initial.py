    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('resource', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='files', to='core.resource')),
            ],
        ),
        migrations.CreateModel(
            name='Plan',
            fields=[
                ...
                ('section_year', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.sectionyear')),
            ],
        ),
        migrations.AddField(
            model_name='chapter',
            name='plan',
            field=models.OneToOneField(on_delete=django.db.models.deletion.PROTECT, to='core.plan'),
        ),
        migrations.CreateModel(
            name='Assingnment',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('assignment', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='files', to='core.assingnment')),
            ],
        ),
    ]
